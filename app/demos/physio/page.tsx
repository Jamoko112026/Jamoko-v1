...
export const metadata: Metadata = {
  title: "Demo Physiotherapie",
  description:
    "Demo-Landingpage für eine Physiotherapiepraxis im ruhigen JaMoKo-Stil.",
  robots: {
    index: false,
    follow: false,
  },
...
const points = [
  ...
  "Leistungen verständlich sortiert",
  "Kontaktaufnahme ohne Umwege",
];
        ...
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-5 text-4xl font-light leading-tight text-white sm:text-5xl md:text-6xl">
              Website-Demo für eine Physiotherapiepraxis.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/58">
              Diese Demo zeigt, wie eine Praxis Leistungen, Vertrauen und
              Kontaktmöglichkeiten ruhig und verständlich führen kann.
            </p>
            <Link
              href="/kontakt"
          ...
          <div className="relative aspect-[4/3] overflow-hidden rounded-3xl border border-white/10 bg-[#06252f]">
            <Image
              ...
              alt="Demo-Ansicht für eine Physiotherapiepraxis"
              fill
              priority
